...
// EXACT 251 REAL PLAYERS POOL WITH UPDATED REAL PHOTOS & CHARLIE DEAN
const MASTER_PLAYERS = [
  // 1 - 8 (Your Provided 8 Stars with Direct Photos)
  ...
  { name: "Sophie Ecclestone", role: "Bowler", country: "ENG", isOverseas: true, basePrice: 50, rating: 96, stats: { mat: 86, runs: 230, sr: 112.1, wkt: 126 }, img: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Sophie_Ecclestone_2023.jpg/440px-Sophie_Ecclestone_2023.jpg" },
  { name: "Harleen Deol", role: "Batter", country: "IND", isOverseas: false, basePrice: 50, rating: 85, stats: { mat: 24, runs: 251, sr: 112.0, wkt: 6 }, img: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Harleen_Deol.jpg/440px-Harleen_Deol.jpg" },
  { name: "Charlie Dean", role: "All-Rounder", country: "ENG", isOverseas: true, basePrice: 30, rating: 86, stats: { mat: 30, runs: 180, sr: 114.0, wkt: 38 }, img: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Charlie_Dean%2C_Eng_v_Aus%2C_18-07-23.jpg/440px-Charlie_Dean%2C_Eng_v_Aus%2C_18-07-23.jpg" },

  // 9 - 36 (Top World / WPL Stars)
...
const EXACT_DATABASE = [
  ...
  // BOWLERS
  { name: "Kate Cross", role: "Bowler", country: "ENG", isOverseas: true, basePrice: 30, rating: 86 },
